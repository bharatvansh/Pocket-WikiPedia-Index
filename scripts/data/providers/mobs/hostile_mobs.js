...
export const hostileMobs = {
    ...
    "minecraft:elder_guardian": {
        ...
        spawning: {
            biomes: ["Ocean Monument"],
            lightLevel: "Any (requires water)",
            groupSize: "3 per monument (1 Elder, 2 regular Guardians)"
        },
        behaviorTraits: [
            ...
            "Attacks with a powerful laser beam that deals damage based on difficulty (8 on Easy, 8 on Normal, 12 on Hard)",
    ...
    "minecraft:phantom": {
        ...
        health: 20,
        stats: {
            attackDamage: "2 (Easy), 3 (Normal), 4.5 (Hard)",
            movementSpeed: 0.4
        },
        classification: {
            type: "Hostile",
        ...
        behaviorTraits: [
            ...
            "Size varies based on days since player's last sleep: small (after 3-5 days), medium (6-10 days), large (11+ days)",
            ...
            "Each swoop attack deals damage based on difficulty (2 on Easy, 3 on Normal, 4.5 on Hard)",
        ...
        drops: [
            { item: "Phantom Membrane", chance: "0-2 (increased by Looting)" },
            { item: "Experience", chance: "5 (when killed by player/tamed wolf)" },
            { item: "Saddle", chance: "If equipped (rare, when spawned with equipment)" }
        ],
        description: "Phantoms are terrifying flying hostile mobs that materialize in the night sky when players have not slept for at least three consecutive in-game days. These ghostly creatures appear as large, translucent winged entities with glowing green eyes, haunting sleepless adventurers as punishment for their insomnia. Phantoms spawn in groups that increase in size the longer a player goes without sleeping—starting with 1-4 after three sleepless nights and potentially reaching 6-10 after many days without rest. Their appearance also scales with time, with phantoms growing larger (small after 3-5 days, medium after 6-10 days, and large after 11+ days) as the player's sleep deprivation continues. During combat, phantoms fly in lazy circles high above their target, periodically swooping down to deliver a devastating melee attack that deals 2 damage on Easy, 3 on Normal, and 4.5 on Hard difficulty. Players must time their attacks carefully during these swoops, as phantoms are otherwise difficult to hit when circling at altitude. Being undead mobs, phantoms burn in sunlight when morning arrives and take extra damage from the Smite enchantment. Their most valuable drop is the phantom membrane, a crucial crafting material used to repair elytra, the coveted wings that allow players to glide through the air. Each phantom drops 0-2 membranes, making them the primary renewable source for elytra repair. Phantoms also drop experience, and on rare occasions may spawn equipped with a saddle which they drop when killed. The best way to prevent phantom spawns is to sleep regularly in a bed, which resets the insomnia counter and causes all pursuing phantoms to despawn peacefully. Their eerie presence in the night sky serves as a constant reminder to players that rest is essential in the harsh world of Minecraft."
    },
    "minecraft:drowned": {

...
export const workstationBlocks = {
    ...
    "minecraft:stonecutter": {
        ...
        description: "A Stonecutter is a workstation block used to craft stone-related blocks in smaller quantities and with more variety than a crafting table. It allows players to turn one block of stone, cobblestone, or other masonry materials into stairs, slabs, walls, and chiseled variants without the 6-block cost of traditional crafting. Crafted from three stone blocks and one iron ingot, it also serves as the job site block for Mason villagers. The spinning blade on top is purely visual and does not damage players or mobs walking on it."
    }
};

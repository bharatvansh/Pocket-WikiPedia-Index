...
export const workstationBlocks = {
    ...
    "minecraft:stonecutter": {
        ...
        description: "A Stonecutter is a workstation block used to craft stone-related blocks in precise quantities. It serves as a more efficient alternative to the crafting table for stone recipes, often allowing 1:1 conversion (e.g., 1 stone to 1 stone stair) instead of the bulk recipes required by a crafting table. It is the job site block for Mason villagers. While it features a spinning saw blade animation, it does not damage players or entities in Bedrock Edition."
    }
};

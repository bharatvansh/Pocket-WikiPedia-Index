...
export const interactiveBlocks = {
    ...
    "minecraft:pink_candle_cake": {
        ...
        description: "Pink Candle Cake is a celebratory block created by placing a single pink candle on an uneaten cake. When lit with flint and steel, it emits a light level of 3, providing a soft and festive glow perfect for in-game celebrations. In Bedrock Edition, if a player eats a slice of the cake, the pink candle drops as an item and the block reverts to a regular cake with a slice missing. Similarly, if the block is broken, only the candle is recovered while the cake is destroyed. It combines a functional food source with a decorative light, making it a favorite for birthdays and themed interior designs."
    }
};

...
export const containerBlocks = {
    ...
    "minecraft:purple_shulker_box": {
        ...
        description: "The Purple Shulker Box is a versatile portable storage block that retains its contents even when broken and carried in the inventory. It is crafted by combining a standard shulker box with purple dye. With 27 slots of storage space, it effectively expands a player's inventory capacity for long-distance transport. In Bedrock Edition, it can be mined with any tool or by hand to be relocated. It cannot be opened if there is a solid block directly above it, and its royal purple color is perfect for organizing high-value items or end-related resources."
    }
};

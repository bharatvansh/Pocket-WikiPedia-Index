...
export const brickBlocks = {
    ...
    "minecraft:mud_brick_wall": {
        ...
        description: "The Mud Brick Wall is a decorative defensive block introduced in the 1.19 Wild Update. It is crafted from Mud Bricks and serves as a thin, solid barrier that is 1.5 blocks high for entities, preventing them from jumping over. With its warm, earthy brown tone, it is perfect for southern, desert, or rustic builds. Like other walls, it connects automatically to adjacent blocks and walls, making it a versatile tool for fences, garden boundaries, and fortifications."
    },

...
export const concreteBlocks = {
    ...
    "minecraft:gray_concrete": {
        ...
        description: "Gray Concrete is a solid building block known for its smooth, matte texture and uniform neutral gray color. It is produced by exposing Gray Concrete Powder to water, which hardens it instantly. Builders often use it for industrial designs, roads, and modern architecture due to its clean appearance without distracting patterns. Unlike wool, gray concrete is fire-resistant and offers better blast resistance, making it a more durable and safe choice for permanent structures in a variety of environments."
    },
    ...
    "minecraft:purple_concrete": {
        ...
        drops: ["minecraft:purple_concrete"],
        generation: {
            dimension: "None",
            yRange: "Crafted only"
        },
    ...
    "minecraft:light_gray_concrete_powder": {
        ...
        drops: ["Light Gray Concrete Powder"],
        generation: {
            dimension: "None",
            yRange: "Crafted only"
        },
        description: "Light Gray Concrete Powder is a gravity-affected building block with a grainy, sand-like texture and a neutral light gray hue. It is crafted from four sand, four gravel, and one light gray dye. When this block comes into contact with water, it instantly solidifies into smooth Light Gray Concrete. Due to its physics, it will fall if the supporting block beneath it is removed, making it useful for certain traps, temporary structures, or decorative landscaping. It provides a more textured appearance compared to the hardened concrete variant."
    }
};

...
export const endBlocks = {
    ...
    "minecraft:dragon_egg": {
        ...
        generation: {
            dimension: "The End",
            yRange: "Exit Portal surface"
        },
        description: "The Dragon Egg is a rare trophy block that appears on top of the Exit Portal after the Ender Dragon is defeated for the first time. It is widely considered the rarest item in the game. When clicked in survival mode, it teleports to a nearby location, making it impossible to mine directly by hand. To harvest it, players must use a piston to push it or have it fall onto a non-solid block like a torch or slab. It is the only block in the game that emits a faint purple particle effect similar to Endermen and is primary used as a decorative trophy of victory."
    }
};

...
export const endBlocks = {
    ...
    "minecraft:dragon_egg": {
        ...
        drops: ["Dragon Egg (only via piston push)"],
        generation: {
            dimension: "The End",
            yRange: "Main island exit portal"
        },
        description: "The Dragon Egg is a rare trophy block that spawns atop the exit portal after defeating the Ender Dragon. It cannot be mined normally; left-clicking causes it to teleport to a random location within a 31-block radius. In Bedrock Edition, it can only be collected by pushing it with a piston, which allows it to drop as an item. The egg serves as a prestigious trophy and decorative item for players who have conquered the End dimension. It emits a faint light level of 1 and features a unique teleportation mechanic that makes collecting it a puzzle-like challenge."
    }
};

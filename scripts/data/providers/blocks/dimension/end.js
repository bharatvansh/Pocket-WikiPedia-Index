...
export const endBlocks = {
    ...
    "minecraft:dragon_egg": {
        ...
        description: "The Dragon Egg is a rare decorative block that appears on top of the exit portal after defeating the Ender Dragon. It is subject to gravity and teleports when clicked or hit, making it difficult to mine directly. To collect it, players must cause it to fall onto a non-solid block like a torch or slab, or push it with a piston. In Bedrock Edition, two Dragon Eggs can be obtained legitimately: one from the first dragon kill and another from the second. It emits a faint light level of 1 and serves as the ultimate trophy of survival."
    },
    "minecraft:end_portal_frame": {
        ...
        description: "The End Portal Frame is a technical block found in Strongholds that forms the ring of the End Portal. Each frame has a socket that may contain an Eye of Ender; once all 12 frames are filled, the portal activates. The block emits a low light level of 1 and is indestructible in Survival mode, similar to Bedrock. In Creative mode, it can be placed to create custom portals. The frame has a distinct turquoise texture with a cream-colored top where the Eye of Ender sits."
    }
};

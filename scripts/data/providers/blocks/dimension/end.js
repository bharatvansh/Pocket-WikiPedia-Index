...
export const endBlocks = {
    ...
    "minecraft:dragon_egg": {
        ...
        description: "The Dragon Egg is a unique decorative block that appears on top of the exit portal after the first Ender Dragon is defeated. It is affected by gravity and will teleport to a nearby location when clicked or attacked, making it difficult to mine directly. To collect it, players typically push it with a piston or make it fall onto a non-solid block like a torch. In Bedrock Edition, it emits a low light level of 1. It is considered a trophy item and serves no crafting purpose."
    }
};

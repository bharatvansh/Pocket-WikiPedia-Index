...
export const endBlocks = {
    ...
    "minecraft:dragon_egg": {
        ...
        generation: {
            dimension: "The End",
            yRange: "Bedrock fountain (after defeating Ender Dragon)"
        },
        description: "The Dragon Egg is a rare decorative trophy block that generates on the bedrock fountain in the End after the Ender Dragon is defeated for the first time. It is unique as only one egg exists naturally per world. When a player interacts with it, the egg teleports to a nearby location. It can be harvested by pushing it with a piston or by breaking the block beneath it and letting it fall onto a non-solid block like a torch. It emits a light level of 1 and is often used as a prestigious centerpiece in survival bases."
    }
};

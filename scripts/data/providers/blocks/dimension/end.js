...
export const endBlocks = {
    ...
    "minecraft:dragon_egg": {
        ...
        description: "The Dragon Egg is a decorative block that generates atop the exit portal when the Ender Dragon is defeated for the first time. It is the rarest block in Minecraft, as only one spawns per world in Bedrock Edition. The egg emits a faint light level of 1 and features a distinctive black texture with purple particles. When clicked, it teleports to a random nearby location. To collect it, players must push it with a piston or let it fall onto a non-solid block like a torch. Affected by gravity like sand and gravel, it serves as a trophy symbolizing victory over the Ender Dragon."
    }
};

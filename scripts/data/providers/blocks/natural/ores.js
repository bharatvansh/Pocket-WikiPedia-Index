...
export const oreBlocks = {
    "minecraft:iron_ore": {
        ...
        drops: ["Raw Iron (1-1 with Fortune I, 1-3 with Fortune II, 1-4 with Fortune III)"],
        generation: {
            dimension: "Overworld",
            yRange: "-64 to 320 (multiple batches)"
        },
        description: "Iron Ore is a common mineral block found throughout the Overworld that drops raw iron when mined. It generates in three batches: most abundantly between Y 80-384 peaking at Y 232, another batch between Y -24 to 56 peaking at Y 16, and a third batch evenly distributed from Y -64 to 72. Iron can be smelted into iron ingots, one of the most essential materials in Minecraft used for tools, armor, and countless crafting recipes. Its abundance makes it the backbone of early-to-mid game progression."
    },
    "minecraft:gold_ore": {

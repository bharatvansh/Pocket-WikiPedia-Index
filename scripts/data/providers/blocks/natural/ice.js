...
export const iceBlocks = {
    ...
    "minecraft:bubble_column": {
        ...
        generation: {
            dimension: "Overworld",
            yRange: "Underwater (above magma blocks or soul sand)"
        },
        description: "A Bubble Column is a temporary water-based block created when soul sand or magma blocks are placed underwater. Bubble columns generated by soul sand push entities upward, while magma block bubble columns push downward. Players and air-breathing mobs inside can replenish air supply at normal speed. The column propagates through water source blocks and stops at flowing water. In Bedrock Edition, bubble columns offer rapid underwater transport for exploration and farming operations, but cannot be placed directly as items."
    }
};

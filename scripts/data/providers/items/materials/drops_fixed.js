...
export const mobDrops = {
    ...
    "minecraft:ender_pearl": {
        ...
        enchantable: false,
        usage: {
            primaryUse: "Teleportation when thrown",
            secondaryUse: "Crafting Eyes of Ender"
        },
        crafting: {
            recipeType: "Shapeless",
            ingredients: ["Ender Pearl + Blaze Powder = Eye of Ender"]
        },
        specialNotes: [
            "Dropped by Endermen (0-1; up to 4 with Looting III in Bedrock)",
            "Can be thrown to teleport to where it lands (2.5 hearts fall damage per use)",
            "1-second cooldown between throws in Bedrock Edition",
            "Has a 5% chance to spawn an Endermite when thrown",
            "Essential for crafting Eyes of Ender to locate and activate End Portals",
            "Can be used to craft Ender Chests (Eye of Ender + Obsidian)"
        ],
        description: "The Ender Pearl is a mystical item dropped by Endermen, tall, dark-purple mobs that teleport around the player. When thrown, it teleports the player to its landing point at the cost of taking 2.5 hearts of fall damage, regardless of the actual distance. This makes it an invaluable tool for traversing terrain and escaping danger. However, its most critical use is in crafting Eyes of Ender, which are necessary for locating and activating Strongholds to reach the End dimension. Throwing pearls also has a small chance of spawning an Endermite, a rare mob."
    },
    "minecraft:gunpowder": {
        ...
        enchantable: false,
        usage: {
            primaryUse: "Crafting TNT, Firework Rockets, and Firework Stars",
            secondaryUse: "Brewing Splash and Lingering Potions"
        },
        crafting: {
            recipeType: "Shaped",
            ingredients: ["Crafts TNT: Gunpowder x4 + Sand x5", "Crafts Firework Rocket: Paper + Gunpowder x1-3", "Crafts Firework Star: Gunpowder + Dye/other materials"]
        },
        specialNotes: [
            "Dropped by Creepers (0-2), Ghasts (0-2), and Witches (0-6)",
            "Drowned can drop 0-2 when killed with a sword enchanted with Looting",
            "Can also be found in various loot chests including Dungeons, Shipwrecks, and Desert Temples",
            "Essential for creating explosive devices: TNT, Firework Rockets, and Firework Stars",
            "Used to brew Splash Potions (Awkward Potion + Gunpowder)",
            "Used to brew Lingering Potions (Splash Potion + Dragon's Breath)",
            "Renewable via Creeper farms"
        ],
        description: "Gunpowder is a volatile powder obtained from hostile mobs and loot chests. It is the primary ingredient for creating explosive devices in Minecraft, including TNT blocks for mining and demolition, as well as Firework Rockets and Stars for celebratory displays. In the realm of brewing, gunpowder transforms regular potions into Splash Potions, which can be thrown to affect multiple targets. This makes it essential for combat-oriented alchemy. Gunpowder is renewable through automated Creeper farms and is a staple resource for both engineering and tactical players."
    },
    "minecraft:magma_cream": {
        ...
        specialNotes: [
            "Dropped by Magma Cubes (small: 25-100%, medium: 25%, large: 0%)",
            "Can also be crafted by combining a Slimeball with Blaze Powder",
            "Primary use is brewing Potion of Fire Resistance (Awkward Potion + Magma Cream)",
            "Used to craft Magma Blocks (4x), which damage entities walking on them",

...
export const specialFood = {
    ...
    "minecraft:ominous_bottle": {
        ...
        specialNotes: [
            ...
            "Drop chance: 18.6% from Standard Vaults, 13.9% from Ominous Vaults"
        ],
        description: "The Ominous Bottle is a consumable item introduced in Minecraft 1.21 that grants the Bad Omen effect when consumed. This item replaced the previous banner-based Bad Omen mechanic, offering more control over the omen system. Ominous Bottles come in five levels (I-V), with the level determining the difficulty of the triggered event rather than the event type. The event type is determined by location: villages trigger Raid Omen for village raids, while Trial Chambers trigger Trial Omen for enhanced trials. In Bedrock Edition, the effect lasts a fixed duration of 1 hour 40 minutes regardless of level. Raid Captains drop these bottles upon defeat, and they can also be found in vault chests with an 18.6% chance from Standard Vaults and 13.9% from Ominous Vaults. The bottle shatters upon consumption, providing no empty glass bottle. This item is essential for players seeking to trigger raids and ominous trials intentionally."
    }
};

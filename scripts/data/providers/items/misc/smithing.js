...
export const smithingTemplates = {
    ...
    "minecraft:sentry_armor_trim_smithing_template": {
        ...
        specialNotes: [
            ...
            "Features a sturdy, reinforced design reminiscent of Pillager gear.",
            "Can be duplicated using 7 Diamonds and 1 Cobblestone.",
            "Consumed upon use in a Smithing Table unless duplicated."
        ],
        description: "The Sentry Armor Trim Smithing Template is a decorative item found in Pillager Outposts. It allows players to customize their armor with the 'Sentry' pattern, featuring a sturdy design reminiscent of Pillager gear. Found in chest loot with a 25% chance, it can be applied to armor at a Smithing Table. To avoid losing the template after a single use, it can be duplicated using seven diamonds and a block of cobblestone."
    },
    "minecraft:shaper_armor_trim_smithing_template": {
        ...
        specialNotes: [
            "Obtained by brushing Suspicious Gravel in Trail Ruins (8.3% chance).",
            "Features geometric shapes reflecting ancient craftsmanship.",
            "Can be duplicated using 7 Diamonds and 1 Terracotta.",
            "Consumed upon use in a Smithing Table unless duplicated."
        ],
        description: "The Shaper Armor Trim Smithing Template is an archaeology find discovered in Trail Ruins. By brushing Suspicious Gravel, players can uncover this template, which applies the 'Shaper' pattern to armor. The design features geometric shapes reflecting ancient craftsmanship. Like other trims, it is consumed on use but can be duplicated using seven diamonds and a block of terracotta, allowing for mass application."
    },
    "minecraft:raiser_armor_trim_smithing_template": {
        ...
        specialNotes: [
            "Obtained by brushing Suspicious Gravel in Trail Ruins (8.3% chance).",
            "Features an uplifting design that highlights upper armor sections.",
            "Can be duplicated using 7 Diamonds and 1 Terracotta.",
            "Consumed upon use in a Smithing Table unless duplicated."
        ],
        description: "The Raiser Armor Trim Smithing Template is a rare item unearthed from Trail Ruins via archaeology. Found by brushing Suspicious Gravel, it grants the 'Raiser' armor pattern, which highlights the upper sections of armor pieces with an uplifting design. Players can duplicate this template using seven diamonds and a block of terracotta, ensuring they can outfit their entire team or armor collection without relying solely on rare drops."
    }
};

...
export async function getBlockDetails(blockId) {
    const blockData = {
        ...
        "minecraft:obsidian": {
            ...
            generation: {
                dimension: "Overworld",
                yRange: "Any (generated by water and lava interaction)"
            },
            description: "Obsidian is one of the hardest and most blast-resistant blocks in Minecraft. It is created when water flows onto lava source blocks. Obsidian is essential for creating nether portals to access the Nether dimension and for building enchanting tables. It requires a diamond pickaxe or better to mine."
        },
        "minecraft:basalt": {
            id: "minecraft:basalt",
            name: "Basalt",
            ...
            generation: {
                dimension: "The Nether",
                yRange: "Any (soul sand valley and basalt deltas)"
            },
            description: "Basalt is a decorative block found naturally in the Nether dimension, particularly in Basalt Deltas and Soul Sand Valleys. It has a smooth, dark gray texture and can be crafted into polished basalt or Blackstone variants. Basalt can be placed in any orientation and is useful for building with dark-colored materials."
        }
    };
